...
class SettingsSeeder extends Seeder
{
    ...
    public function run()
    {
        DB::table('settings')->insert([
            // Site title.
            ['option_name' => 'app_name', 'option_value' => 'Naima Sustainbility'],
            ...
            // Site logo and icons.
            ['option_name' => 'site_logo_lite', 'option_value' => '/images/logo/ns-longl-color.png'],
            ['option_name' => 'site_logo_dark', 'option_value' => '/images/logo/ns-white-color-dark.png'],

...
@section('title')
    {{ __('add_strategy') }} - {{ config('app.name') }}
@endsection

@section('admin-content')
    <div class="container mx-auto px-4 py-8 dark:bg-gray-900 dark:text-white">
        <h1 class="text-2xl font-bold text-gray-800 dark:text-white mb-6">{{__("add_new_guide")}}</h1>
            ...
            <form action="{{ route('admin.guides.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">{{__('main_file_description')}}</p>
                    </div>
                    <div>
                        ...
                        <input type="file" name="thumbnail" id="thumbnail"
                               class="mt-1 py-0.5 ps-3 block w-full text-sm
                                    ...
                                    dark:text-gray-400 dark:file:bg-emerald-800 dark:file:text-emerald-100 dark:hover:file:bg-emerald-700
                                    dark:border-gray-700">
                        <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">{{__('thumbnail_description')}}</p>
                    </div>
                    <div>

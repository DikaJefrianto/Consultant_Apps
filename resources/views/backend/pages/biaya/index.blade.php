        ...
        <div class="mb-6 flex flex-wrap items-center justify-between gap-3">
            ...
            {{-- <nav>
                <ol class="flex items-center gap-1.5">
                    ...
                    <li class="text-sm text-gray-800 dark:text-white/90">{{ __('Biaya') }}</li>
                </ol>
            </nav> --}}
    ...
    <div class="space-y-6">
        <div class="rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
            <div class="px-5 py-4 sm:px-6 sm:py-5 flex justify-between items-center">
                <h3 class="text-base font-medium text-gray-800 dark:text-white/90">{{ __('Daftar Biaya') }}</h3>
            ...
            <div class="space-y-3 border-t border-gray-100 dark:border-gray-800 overflow-x-auto">
                ...
                <table class="w-full dark:text-gray-400">
                    ...
                    <tbody>
                        ...
                        @empty
                            <tr>
                                <td colspan="5" class="text-center py-4 text-gray-500 dark:text-gray-400">{{ __('Tidak ada data biaya') }}</td>
                            </tr>
                        @endforelse
                                ...
                                <div class="relative w-full max-w-md h-full md:h-auto">
                                    <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-700">
                                        ...
                                        <div class="p-4 md:p-5 text-center">
                                            ...
                                            <form action="{{ route('admin.biaya.destroy', $item) }}" method="POST">
                                                @csrf @method('DELETE')
                                                <button type="submit"
